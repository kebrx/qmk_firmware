...
static const char * sendstring_work_commands[] = {
    ...
    "aws -- ansible-playbook -i dev_envs.hosts -i tools.hosts -i production_envs.hosts ", // ANSIBLE
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_ML] = LAYOUT(
        ...
        _______, L_T_MD,  L_T_ONF, _______, _______, MD_BOOT, NK_TOGG, _______, _______, _______, _______, _______,                              KC_BRIU, \
    ...
    [_DLR] = LAYOUT(
        ...
        MO(_DLSR),_______,_______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                              _______, \
    ...
    [_HL] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______,  H_IXIO, _______, _______, _______, _______, _______,   _______, _______, _______, \
    ...
    if (record->event.pressed) {
        ...
        switch (keycode) {
            ...
            case H_NMAP ... H_HTTP:
                ...
                return false;
            case U_VPPR ... U_ADL:
                send_string_with_delay(sendstring_url_commands[keycode - U_ADL], 5);
                return false;
        }
    }
    return true;
